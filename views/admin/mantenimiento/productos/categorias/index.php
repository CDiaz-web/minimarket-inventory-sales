...
<div class="dashboard__contenedor">
    ...
    <a class="dashboard__boton-agregar" href="/admin/mantenimiento/productos/categorias/crear">
    ...
    <button class="dashboard__boton-exportar"  
            onclick="exportarTablaXLSX('tabla', 'categoria.xlsx', 'Categoria')">
        Exportar
    </button>

    <a class="dashboard__boton"  href="/admin/mantenimiento/productos/categorias/cargar">
                ...
                <?php foreach($categorias as $categoria) { ?>
                    <tr class="table__tr">  
                        ...
                        <td class="table__td--acciones">
                            <a class="table__mantenimiento table__mantenimiento--editar" href="/admin/mantenimiento/productos/categorias/editar?id=<?php echo $categoria->id ?>">
                            ...
                            <form id ="frEliminar<?php echo $categoria->id; ?>"  method="POST" action="/admin/mantenimiento/productos/categorias/eliminar" class="table__formulario">
                                ...
                                <button class="table__mantenimiento table__mantenimiento--eliminar"  type="button" data-id="<?php echo $categoria->id; ?>">
