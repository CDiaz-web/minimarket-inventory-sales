...
<div class="dashboard__contenedor">
    ...
    <a class="dashboard__boton-agregar" href="/admin/configuracion/devolucion/crear">
...
<div class="dashboard__contenedor"  id="table_box_master">
                ...
                <?php foreach($devoluciones as $devolucion) { ?>
                    <tr class="table__tr">            
                        ...
                        <td class="table__td--acciones">
                            <a class="table__mantenimiento table__mantenimiento--editar" href="/admin/configuracion/devolucion/editar?id=<?php echo $devolucion->id ?>">
                            ...
                            <form id ="frEliminar<?php echo $devolucion->id; ?>"  method="POST" action="/admin/configuracion/devolucion/eliminar" class="table__formulario">
                                ...
                                <button class="table__mantenimiento table__mantenimiento--eliminar"  type="button" data-id="<?php echo $devolucion->id; ?>">
    ...
    <?php } else { ?>
        <p class="text-center">No hay Motivos Devolucion Registrados</p>
    <?php } ?>
</div>
