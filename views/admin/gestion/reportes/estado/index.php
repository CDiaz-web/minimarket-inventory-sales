    ...
    <div class="table-header">
        <div class="table-actions">
            ...
            <button class="boton boton--success-light"                  
                ...
                data-table="tabla"
                data-file="ventasestado.xlsx"
                data-sheet="Ventas por Estado"
            >
                Exportar xls
            </button>
            <form method="POST" action="/admin/gestion/reportes/pdfestado" target="_blank">
        ...
        <div class="table-actions">
            ...
            <form method="GET" action="/admin/gestion/reportes/estado" class="dashboard__filtros">      
