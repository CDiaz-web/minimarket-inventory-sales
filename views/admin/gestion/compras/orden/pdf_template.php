...
<head>
<meta charset="UTF-8">
<title>Orden de Compra #<?= $cabecera->numero ?></title>
<style>
...
<body>
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><?= number_format($d->costo_igv_origen, 2) ?></td>
  ...
  <p>     
     <strong>Subtotal:</strong> <?= $cabecera->simbolo . " " . $cabecera->subtotal_origen ?><br>
     <strong>IGV:</strong> <?= $cabecera->simbolo . " " .  $cabecera->igv_origen ?><br>
     <strong>Total:</strong> <?= $cabecera->simbolo . " " .  $cabecera->total_origen ?><br>
