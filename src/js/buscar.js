...
const tablabase = document.getElementById("tabla");

    if (!busqueda || !tablabase || !tablabase.tBodies || tablabase.tBodies.length === 0) {
        console.warn(`Buscador: No se encontró input `);
        return;
    }

if(busqueda){
        // console.log(tablabase.tBodies.length )
        var table = document.getElementById("tabla").tBodies[0];
        // Continúa con la lógica de búsqueda...
        ...
        if(table){
            buscaTabla = function(){
                ...
                if(texto ){
                  while(row = table.rows[r++])
                    ...
                    paginator({
                        table: document.getElementById("table_box_master").getElementsByTagName("table")[0],
                        box: document.getElementById("index_native_master"),
                        active_class: "pagina__color_page"
                      });
                }
              }
            ...
            const paginaTabla = document.getElementById("table_box_master")
                ...
                paginator({
                  ...
                  function paginator(config) {
                      ...
                      if (typeof config.box_mode == "function") {
                          ...
                          page_box.classList.add('paginacion');
