...
class SeriesDocumento extends ActiveRecord{
    ...
    protected static $columnasDB = ['id','idempresa','idtienda', 'idtipodocumento','serie','cantidad_digitos','ultimo_correlativo','activo','idusercrea','fechacrea','idusermodi','fechamodi'];
